...
import { testPlacemarks, john } from "../fixtures.js";
...
suite("Placemark Model tests", () => {
  ...
  test("create a placemark", async () => {
    const placemark = await db.placemarkStore.addPlacemark(john);
    // assert.equal(john, placemark);
    assertSubset(john, placemark);
